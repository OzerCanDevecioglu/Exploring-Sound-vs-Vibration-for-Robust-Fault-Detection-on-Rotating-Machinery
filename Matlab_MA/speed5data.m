name='M1\F2-Auto\Rectangular';

listing = dir(name)
listing=listing(3:59);
...
save('MachineA/S5/train/audio_sig.mat','audio_sig')
save('MachineA/S5/train/vib_sig.mat','vib_sig')
save('MachineA/S5/train/label_sig.mat','label_sig')
...
save('MachineA/S5/test/audio_sig.mat','audio_sig')
save('MachineA/S5/test/vib_sig.mat','vib_sig')
save('MachineA/S5/test/label_sig.mat','label_sig')
