...
save('MachineB/S2/train/audio_sig.mat','audio_sig')
save('MachineB/S2/train/vib_sig.mat','vib_sig')
save('MachineB/S2/train/label_sig.mat','label_sig')
...
save('MachineB/S2/test/audio_sig.mat','audio_sig')
save('MachineB/S2/test/vib_sig.mat','vib_sig')
save('MachineB/S2/test/label_sig.mat','label_sig')
