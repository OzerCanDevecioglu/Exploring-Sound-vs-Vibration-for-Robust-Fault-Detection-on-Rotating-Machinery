...
class ECGDataset(Dataset):
    def __init__(self, path, patient_id, split, channel_idx=0):
        ...
        path_data_ch1="C:/Users/ozerc/Desktop/SoundvsVib - MA/mbdata/ch1data_{split}_{patient_id}"
        path_data_ch2="C:/Users/ozerc/Desktop/SoundvsVib - MA/mbdata/ch1data_{split}_{patient_id}"
        label="C:/Users/ozerc/Desktop/SoundvsVib - MA/mbdata/labels_{split}_{patient_id}"
